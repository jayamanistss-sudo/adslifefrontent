  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-[11px] text-[var(--text-muted)] mt-0.5 mb-1.5">
          Pick the category that best matches what your business sells. Choose <strong className="text-[var(--text-secondary)]">Other</strong> only if none of the listed categories fit.
        </p>
        {categories.length === 0 ? (
