...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    refresh();
    // Poll every 30s for near-live figures (new signups, approvals, payments).
    const pollFallback = setInterval(refresh, 30000);
    return () => { cancelled = true; clearInterval(pollFallback); };
  }, []);
