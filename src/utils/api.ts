...
export const endpoints = {
  ...
  audience:  (vendorId?: number, days = 30) => vendorId ? `/analytics/audience?vendor_id=${vendorId}&days=${days}` : `/analytics/audience?days=${days}`,
  heatmap:   (vendorId?: number, days = 30) => vendorId ? `/analytics/heatmap?vendor_id=${vendorId}&days=${days}` : `/analytics/heatmap?days=${days}`,
